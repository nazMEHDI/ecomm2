        ...
        if (!empty($routeMatch)){
            ...
            if (!empty($module[0]))
                if ($module[0] == 'melis-backoffice'){
                    ...
                    (new \Categoriestable\Listener\SavePropertiesListener())->attach($eventManager);
                    (new \Categoriestable\Listener\DeleteListener())->attach($eventManager);
                }
        }
    }
